...
<!-- page title -->
<section class="section section--first section--bg" data-bg="import/img/section/section.jpg">
		<div class="container">
			<div class="row">
				<div class="col-12">
	...
	<section class="section">
		<div class="container">
			<div class="row">
				<!-- section title -->
				<div class="col-12">
					<h2 class="section__title"><b>StreamJoy</b> –The Joy of Watching Movies</h2>
				</div>
				<!-- end section title -->
