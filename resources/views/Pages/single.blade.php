...
@section('content')
	...
	<section class="section details">
		<!-- details background -->
		<div class="details__bg" data-bg="import/img/home/home__bg.jpg"></div>
		...
		<div class="container">
			...
			@if ($loop->first)
				...
				<!-- title -->
				<div class="col-12">
					<h1 class="details__title">{{$list['title']}}</h1>
				</div>
				<!-- end title -->
							...
							<div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-9">
								<div class="card__content">
									<div class="card__wrap">
										<span class="card__rate"><i class="icon ion-ios-star"></i>{{$list['rating']}}</span>
									...
									<ul class="card__meta">
										...
										<a href="#">{{$list['genre']}}</a></li>
										<li><span>Release year:</span> 2017</li>
										<li><span>Running time:</span> {{$list['running_time']}}</li>
										<li><span>Country:</span> <a href="#">{{$list['country']}}</a> </li>
									</ul>
										...
										<ul class="comments__list">
											<li class="comments__item">
												<div class="comments__autor">
													<img class="comments__avatar" src="import/img/user.png" alt="">
										...
										<ul class="reviews__list">
											<li class="reviews__item">
												<div class="reviews__autor">
													<img class="reviews__avatar" src="import/img/user.png" alt="">
							...
							<div class="gallery" itemscope>
								<div class="row">
									...
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="import/img/gallery/project-1.jpg" itemprop="contentUrl" data-size="1920x1280">
											<img src="import/img/gallery/project-1.jpg" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="import/mg/gallery/project-2.jpg" itemprop="contentUrl" data-size="1920x1280">
											<img src="import/img/gallery/project-2.jpg" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="import/img/gallery/project-3.jpg" itemprop="contentUrl" data-size="1920x1280">
											<img src="import/img/gallery/project-3.jpg" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="import/img/gallery/project-4.jpg" itemprop="contentUrl" data-size="1920x1280">
											<img src="import/img/gallery/project-4.jpg" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="import/img/gallery/project-5.jpg" itemprop="contentUrl" data-size="1920x1280">
											<img src="import/img/gallery/project-5.jpg" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="import/mg/gallery/project-6.jpg" itemprop="contentUrl" data-size="1920x1280">
											<img src="import/img/gallery/project-6.jpg" itemprop="thumbnail" alt="Image description" />
										</a>
				...
				<div class="col-12 col-lg-4 col-xl-4">
					<div class="row">
						...
						<div class="col-6 col-sm-4 col-lg-6">
							<div class="card">
								<div class="card__cover">
									<img src="import/img/covers/cover.jpg" alt="">
						...
						<div class="col-6 col-sm-4 col-lg-6">
							<div class="card">
								<div class="card__cover">
									<img src="import/img/covers/cover2.jpg" alt="">
									<a href="#" class="card__play">
										<i class="icon ion-ios-play"></i>
									</a>
								</div>
						...
						<div class="col-6 col-sm-4 col-lg-6">
							<div class="card">
								<div class="card__cover">
									<img src="import/img/covers/cover3.jpg" alt="">
									<a href="#" class="card__play">
										<i class="icon ion-ios-play"></i>
									</a>
								</div>
						...
						<div class="col-6 col-sm-4 col-lg-6">
							<div class="card">
								<div class="card__cover">
									<img src="import/img/covers/cover4.jpg" alt="">
									<a href="#" class="card__play">
										<i class="icon ion-ios-play"></i>
									</a>
								</div>
						...
						<div class="col-6 col-sm-4 col-lg-6">
							<div class="card">
								<div class="card__cover">
									<img src="import/img/covers/cover5.jpg" alt="">
									<a href="#" class="card__play">
										<i class="icon ion-ios-play"></i>
									</a>
								</div>
						...
						<div class="col-6 col-sm-4 col-lg-6">
							<div class="card">
								<div class="card__cover">
									<img src="import/img/covers/cover6.jpg" alt="">
									<a href="#" class="card__play">
										<i class="icon ion-ios-play"></i>
									</a>
								</div>
